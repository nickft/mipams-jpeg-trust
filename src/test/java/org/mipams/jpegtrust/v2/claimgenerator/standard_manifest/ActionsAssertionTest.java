...
public class ActionsAssertionTest {
    ...
    void testActionsAssertionJxl() throws Exception {
        ...
        String targetFileUrl = assetFileUrl.replace("sample.jxl", "s01-standard-manifest-with-actions-2ed.jxl");
    ...
    void testActionsAssertionJp2() throws Exception {
        ...
        String targetFileUrl = assetFileUrl.replace("sample.jp2", "s01-standard-manifest-with-actions-2ed.jp2");
