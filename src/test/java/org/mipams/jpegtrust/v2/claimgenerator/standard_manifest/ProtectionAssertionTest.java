...
public class ProtectionAssertionTest {
    ...
    void testActionsAssertion() throws Exception {
        ...
        String assetFileUrl = initialAssetFileUrl.replace("sample", "s09");
        ...
        String targetFileUrl = assetFileUrl.replace(".jpeg", "-standard-manifest-with-protected-assertion-2ed.jpeg");
