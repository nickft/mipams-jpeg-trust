...
public class ExtentOfModificationAssertionTest {
    ...
    void testActionsAssertion() throws Exception {
        ...
        String assetFileUrl = initialAssetFileUrl.replace("sample", "s02");
        ...
        String targetFileUrl = assetFileUrl.replace(".jpeg", "-standard-manifest-extent-of-modifications-2ed.jpeg");
