...
public class CawgMetadataAssertionTest {
    ...
    @Test
    void testCawgMetadataJpeg1() throws Exception {
        String assetFileUrl = ResourceUtils.getFile("classpath:sample.jpeg").getAbsolutePath();
        String targetFileUrl = assetFileUrl.replace("sample.jpeg", "s04-cawg-metadata-2ed.jpeg");
    ...
    @Test
    void testCawgMetadataJxl() throws Exception {
        String assetFileUrl = ResourceUtils.getFile("classpath:sample.jxl").getAbsolutePath();
        String targetFileUrl = assetFileUrl.replace("sample.jxl", "s04-cawg-metadata-2ed.jxl");
    ...
    @Test
    void testCawgMetadataJp2() throws Exception {
        String assetFileUrl = ResourceUtils.getFile("classpath:sample.jp2").getAbsolutePath();
        String targetFileUrl = assetFileUrl.replace("sample.jp2", "s04-cawg-metadata-2ed.jp2");
