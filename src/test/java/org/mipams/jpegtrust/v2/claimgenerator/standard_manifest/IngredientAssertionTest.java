...
public class IngredientAssertionTest {
    ...
    void testActionsAssertion() throws Exception {
        ...
        String assetFileUrl = initialAssetFileUrl.replace("sample", "s03");
        ...
        String targetFileUrl = assetFileUrl.replace(".jpeg", "-standard-manifest-ingredient-assertion-2ed.jpeg");
