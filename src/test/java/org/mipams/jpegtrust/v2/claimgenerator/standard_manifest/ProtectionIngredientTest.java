...
public class ProtectionIngredientTest {
    ...
    void testActionsAssertion() throws Exception {
        ...
        String assetFileUrl = initialAssetFileUrl.replace("sample", "s10");
        ...
        String targetFileUrl = assetFileUrl.replace(".jpeg", "-standard-manifest-with-protected-ingredient-2ed.jpeg");
