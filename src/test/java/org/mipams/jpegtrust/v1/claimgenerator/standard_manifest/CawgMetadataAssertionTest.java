...
public class CawgMetadataAssertionTest {
    ...
    void testCawgMetadataJpeg1() throws Exception {
        ...
        String targetFileUrl = assetFileUrl.replace("sample.jpeg", "s04-cawg-metadata.jpeg");
    ...
    void testCawgMetadataJxl() throws Exception {
        ...
        String targetFileUrl = assetFileUrl.replace("sample.jxl", "s04-cawg-metadata.jxl");
    ...
    void testCawgMetadataJp2() throws Exception {
        ...
        String targetFileUrl = assetFileUrl.replace("sample.jp2", "s04-cawg-metadata.jp2");
