...
public class ExtentOfModificationAssertionTest {
    ...
    void testExtentOfModJpeg1() throws Exception {
        ...
        String targetFileUrl = assetFileUrl.replace("sample.jpeg", "s02-extent-of-mod.jpeg");
    ...
    void testExtentOfModJxl() throws Exception {
        ...
        String targetFileUrl = assetFileUrl.replace("sample.jxl", "s02-extent-of-mod.jxl");
    ...
    void testExtentOfModJp2() throws Exception {
        ...
        String targetFileUrl = assetFileUrl.replace("sample.jp2", "s02-extent-of-mod.jp2");
