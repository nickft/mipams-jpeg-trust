...
public class IngredientAssertionTest {
    ...
    void testIngredientAssertionJpeg1() throws Exception {
        ...
        String targetFileUrl = assetFileUrl.replace("sample.jpeg", "s03-ingredient.jpeg");
    ...
    void testIngredientAssertionJxl() throws Exception {
        ...
        String targetFileUrl = assetFileUrl.replace("sample.jxl", "s03-ingredient.jxl");
    ...
    void testIngredientAssertionJp2() throws Exception {
        ...
        String targetFileUrl = assetFileUrl.replace("sample.jp2", "s03-ingredient.jp2");
    ...
    private JumbfBox constructTrustRecordForScenario(String assetFileUrl, String mediaType) throws Exception {
        ...
        final IngredientAssertionV1 ingredientAssertion = ManifestScenarios.getIngredientAssertion(ingredientManifest,
